...
export default function Services() {
  const services = [
    ...
    },
    {
      ...
      description: "Advanced surveillance  Courses for residential and commercial spaces.",
      features: [
        "Advanced Cameras",
        "Storage  Courses",
        "Video Analytics",
    ...
    },
    {
      ...
      description: "Scalable cloud  Courses for modern business needs.",
      features: [
        "Cloud Migration",
        "Hybrid Cloud",
        "Cloud Security",
    ...
    <main className="flex-grow container mx-auto px-6 py-24">
      ...
      >
        ...
        <p className="text-xl text-gray-700 mb-12">
          We offer a comprehensive range of technology  Courses designed to meet the evolving needs of modern businesses and individuals.
        </p>
